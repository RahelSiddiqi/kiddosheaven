...
class InventoryFinanceSeeder extends Seeder
{
    ...
    {
        $products = [
            ['name' => 'Organic Baby Food', 'sku' => 'BF-001', 'price' => 250, 'cost_price' => 150, 'stock' => 100, 'catalog_id' => 1],
            ['name' => 'Baby Diapers Pack', 'sku' => 'DP-001', 'price' => 800, 'cost_price' => 500, 'stock' => 200, 'catalog_id' => 1],
            ['name' => 'Baby Wipes', 'sku' => 'BW-001', 'price' => 150, 'cost_price' => 80, 'stock' => 300, 'catalog_id' => 1],
            ['name' => 'Baby Shampoo', 'sku' => 'BS-001', 'price' => 350, 'cost_price' => 180, 'stock' => 150, 'catalog_id' => 1],
            ['name' => 'Baby Lotion', 'sku' => 'BL-001', 'price' => 400, 'cost_price' => 220, 'stock' => 120, 'catalog_id' => 1],
            ['name' => 'Soft Teddy Bear', 'sku' => 'TB-001', 'price' => 800, 'cost_price' => 350, 'stock' => 50, 'catalog_id' => 2],
            ['name' => 'Building Blocks Set', 'sku' => 'BB-001', 'price' => 1200, 'cost_price' => 500, 'stock' => 75, 'catalog_id' => 2],
            ['name' => 'Educational Puzzle', 'sku' => 'EP-001', 'price' => 600, 'cost_price' => 250, 'stock' => 100, 'catalog_id' => 2],
            ['name' => 'Remote Control Car', 'sku' => 'RC-001', 'price' => 1500, 'cost_price' => 700, 'stock' => 40, 'catalog_id' => 2],
            ['name' => 'Doll House', 'sku' => 'DH-001', 'price' => 2000, 'cost_price' => 900, 'stock' => 30, 'catalog_id' => 2],
            ['name' => 'Baby Onesie Set', 'sku' => 'OS-001', 'price' => 500, 'cost_price' => 200, 'stock' => 200, 'catalog_id' => 3],
            ['name' => 'Baby Socks Pack', 'sku' => 'SK-001', 'price' => 200, 'cost_price' => 80, 'stock' => 300, 'catalog_id' => 3],
            ['name' => 'Baby Hat', 'sku' => 'HT-001', 'price' => 250, 'cost_price' => 100, 'stock' => 150, 'catalog_id' => 3],
            ['name' => 'Baby Blanket', 'sku' => 'BLK-001', 'price' => 600, 'cost_price' => 280, 'stock' => 80, 'catalog_id' => 3],
            ['name' => 'Baby Booties', 'sku' => 'BT-001', 'price' => 350, 'cost_price' => 150, 'stock' => 120, 'catalog_id' => 3],
            ['name' => 'Baby Bottle', 'sku' => 'BBT-001', 'price' => 450, 'cost_price' => 200, 'stock' => 180, 'catalog_id' => 1],
            ['name' => 'Pacifier Set', 'sku' => 'PC-001', 'price' => 300, 'cost_price' => 120, 'stock' => 200, 'catalog_id' => 1],
            ['name' => 'Baby Nail Clipper', 'sku' => 'NC-001', 'price' => 180, 'cost_price' => 70, 'stock' => 150, 'catalog_id' => 1],
            ['name' => 'Baby Thermometer', 'sku' => 'TH-001', 'price' => 500, 'cost_price' => 220, 'stock' => 100, 'catalog_id' => 1],
            ['name' => 'Baby Stroller', 'sku' => 'ST-001', 'price' => 8500, 'cost_price' => 4000, 'stock' => 20, 'catalog_id' => 1],
        ];
        ...
        foreach ($products as $product) {
            DB::table('products')->insert([
                ...
                'stock' => $product['stock'],
                'catalog_id' => $product['catalog_id'] ?? 1,
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ]);
