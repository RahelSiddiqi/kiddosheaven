...
@section('title', 'About Us — KiddosHeaven')

@section('content')
	<div class="container mx-auto bg-white rounded-xl shadow p-8 mt-8">
		<h1 class="text-4xl font-extrabold mb-6 text-[var(--color-primary-dark)]">About KiddosHeaven</h1>
		<p class="text-lg text-gray-700 mb-4">
			Welcome to KiddosHeaven, your trusted destination for delightful, safe, and sustainable toys! Founded by parents for
		...
		<div class="grid md:grid-cols-2 gap-8 mb-6">
			<div>
				...
				<p class="text-gray-600 mb-2">KiddosHeaven began with a simple idea: to make playtime magical and meaningful. We
