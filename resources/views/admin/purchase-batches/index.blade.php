                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="border-gray-200 border-y dark:border-gray-700">
                                ...
                                <th scope="col" class="px-4 py-3 font-normal text-gray-500 text-start text-theme-sm dark:text-gray-400">Received</th>
                                <th scope="col" class="px-4 py-3 font-normal text-gray-500 text-start text-theme-sm dark:text-gray-400">Remaining</th>
                                <th scope="col" class="px-4 py-3 font-normal text-gray-500 text-start text-theme-sm dark:text-gray-400">Total Value</th>
                                <th scope="col" class="px-4 py-3 font-normal text-gray-500 text-start text-theme-sm dark:text-gray-400">Expiry</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse($batches as $batch)
                                <tr>
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-500 dark:text-gray-400">{{ number_format($batch->unit_cost * $batch->remaining_quantity, 2) }} BDT</div>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        @if($batch->remaining_quantity > 0)
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-50 text-green-600 dark:bg-green-500/15 dark:text-green-500">
                                                Active
                                            </span>
                                        @else
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-50 text-gray-600 dark:bg-gray-500/15 dark:text-gray-400">
                                                Exhausted
                                            </span>
                                        @endif
                                    </td>
        ...
        <div @click.away="showDeleteModal = false" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="text-center">
                ...
                <p class="mb-6 text-sm text-gray-500 dark:text-gray-400">
                    Are you sure you want to delete batch <strong x-text="deleteBatchNumber" class="text-gray-700 dark:text-gray-200"></strong>?
                </p>
