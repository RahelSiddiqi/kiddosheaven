...
@section('content')
	<div class="grid grid-cols-12 gap-4 md:gap-6">
		<div class="col-span-12">
			<x-admin.ui.entity-header title="Partner Report" :breadcrumbs="[
			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
				<x-admin.ui.stat-card label="Total Partners" :value="$partners->count()" icon="users" color="blue" />
				<x-admin.ui.stat-card label="Total Paid" value="৳{{ number_format($totalPaid, 2) }}" icon="dollar" color="green" />
				<x-admin.ui.stat-card label="Pending Payments" value="৳{{ number_format($pendingPayments, 2) }}" icon="alert"
					color="yellow" />
			</div>
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:flex xl:flex-nowrap items-end gap-4">
