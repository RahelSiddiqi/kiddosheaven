	...
	<div class="grid grid-cols-12 gap-4 md:gap-6">
		<div class="col-span-12">
			...
			<div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
				<x-admin.ui.stat-card title="Points Issued" :value="number_format($stats['total_points_issued'])" icon="currency" color="green" />
				<x-admin.ui.stat-card title="Points Redeemed" :value="number_format($stats['total_points_redeemed'])" icon="cart" color="red" />
				<x-admin.ui.stat-card title="Active Users" :value="number_format($stats['active_users'])" icon="users" color="blue" />
				<x-admin.ui.stat-card title="Status" :value="$stats['active_program'] ? 'Active' : 'Inactive'" icon="check" :color="$stats['active_program'] ? 'green' : 'yellow'" />
			</div>
