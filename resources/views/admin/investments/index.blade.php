				...
				<div class="grid grid-cols-12 gap-4 md:gap-6 mb-6">
							...
							<div class="flex items-center justify-between">
								<div>
									...
									<h4 class="mt-1 font-bold text-gray-800 text-title-sm dark:text-white/90">
										{{ number_format($investments->sum('amount'), 2) }}</h4>
								</div>
					...
					<div class="col-span-12 lg:col-span-4">
						<div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
							<div class="flex items-center justify-between">
								<div>
									<span class="text-sm text-gray-500 dark:text-gray-400">Active Investments</span>
									<h4 class="mt-1 font-bold text-gray-800 text-title-sm dark:text-white/90">
										{{ $investments->where('status', 'active')->count() }}</h4>
								</div>
						...
						<div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
							<div class="flex items-center justify-between">
								<div>
									...
									<h4 class="mt-1 font-bold text-gray-800 text-title-sm dark:text-white/90">
										{{ number_format($investments->count(), 0) }}</h4>
								</div>
