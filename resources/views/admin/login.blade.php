						...
						<div>
									...
									<div class="flex items-center justify-between">
										<label for="remember"
											...
											<input type="checkbox" id="remember" name="remember"
												class="mr-3 h-5 w-5 rounded border-gray-300 text-brand-500 focus:ring-brand-500 dark:border-gray-600 dark:bg-gray-700" />
											Keep me logged in
										</label>
							...
							<div class="mt-5">
								<p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
									...
									<a href="#" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Sign Up</a>
								</p>
							</div>
						</div>
					</div>
