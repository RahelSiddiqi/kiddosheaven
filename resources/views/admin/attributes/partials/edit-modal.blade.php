	...
	<div class="flex min-h-screen items-center justify-center p-4">
		...
		<div
			...
			<div class="flex items-center justify-between p-5 border-b border-gray-200 dark:border-gray-700">
				<h3 class="text-lg font-semibold text-gray-800 dark:text-white">Edit Attribute</h3>
			...
			<form id="editAttributeForm" @submit.prevent="updateAttribute()" class="p-5 space-y-4">
				@csrf
				@method('PUT')
				{{-- Validation Errors --}}
				...
				<div>
					<label for="edit_attribute_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Name
						*</label>
					<input type="text" name="name" id="edit_attribute_name" required
				...
				<div>
					<label for="edit_attribute_type" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Input Type
						*</label>
					<select name="type" id="edit_attribute_type" required
						class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs focus:border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:focus:border-blue-800">
				...
				<div>
					...
					<div class="flex flex-wrap gap-4">
						<label class="flex items-center gap-2 cursor-pointer">
							<input type="checkbox" name="is_required" id="edit_attribute_required" value="1"
						...
						<label class="flex items-center gap-2 cursor-pointer">
							<input type="checkbox" name="is_filterable" id="edit_attribute_filterable" value="1"
								class="h-4 w-4 rounded border-gray-300 text-blue-500 focus:ring-blue-500/10 dark:border-gray-600 dark:bg-gray-700 cursor-pointer">
				...
				<div>
					<label for="edit_attribute_description"
						class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Description</label>
					<textarea name="description" id="edit_attribute_description" rows="3"
