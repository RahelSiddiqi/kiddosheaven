	...
	<div class="flex min-h-screen items-center justify-center p-4">
		...
		<div
			...
			<div class="flex items-center justify-between p-5 border-b border-gray-200 dark:border-gray-700">
				<h3 class="text-lg font-semibold text-gray-800 dark:text-white">Add New Brand</h3>
			...
			<form id="addBrandForm" @submit.prevent="saveBrand()" class="p-5 space-y-4">
				@csrf
				{{-- Validation Errors --}}
				...
				<div>
					<label for="brand_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Name *</label>
					<input type="text" name="name" id="brand_name" x-model="formData.name" required
						class="h-11 w-full rounded-lg border @error('name') border-red-500
@else
border-gray-300 @endempty bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs focus:border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:focus:border-blue-800">
				</div>
				<div>
					<label for="brand_slug" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Slug</label>
					<input type="text" name="slug" id="brand_slug" x-model="formData.slug"
				...
				<div>
					...
					<textarea name="description" id="brand_description" x-model="formData.description" rows="3"
				...
				<div>
					<label for="brand_logo" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Logo *</label>
					<input type="file" name="logo" id="brand_logo" accept="image/*"
						@change="formData.logo = $event.target.files[0]"
					...
					<p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Supported formats: JPG, PNG, GIF, SVG</p>
				</div>
				<div>
				...
				<div class="flex justify-end gap-3 pt-4">
					...
					<button type="submit" :disabled="isSubmitting"
						...
						<span x-show="!isSubmitting">Add Brand</span>
