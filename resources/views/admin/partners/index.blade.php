				...
				<div class="grid grid-cols-12 gap-4 md:gap-6 mb-6">
					<div class="col-span-12 lg:col-span-4">
						<div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
							<div class="flex items-center justify-between">
								<div>
									<span class="text-sm text-gray-500 dark:text-gray-400">Total Partners</span>
									<h4 class="mt-1 font-bold text-gray-800 text-title-sm dark:text-white/90">{{ $partners->count() }}</h4>
								</div>
							...
							<div class="flex items-center justify-between">
								<div>
									...
									<h4 class="mt-1 font-bold text-gray-800 text-title-sm dark:text-white/90">
										{{ $partners->where('status', 'active')->count() }}</h4>
								</div>
					...
					<div class="col-span-12 lg:col-span-4">
						<div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
							<div class="flex items-center justify-between">
								<div>
									<span class="text-sm text-gray-500 dark:text-gray-400">Total Commission Paid</span>
									<h4 class="mt-1 font-bold text-gray-800 text-title-sm dark:text-white/90">
										{{ number_format($partners->sum('total_commission_paid') ?? 0, 2) }}</h4>
								</div>
