<div class="relative" x-data="{
    ...
    <button
        ...
        type="button"
    >
        <span class="mr-3 flex items-center justify-center overflow-hidden rounded-full h-11 w-11 bg-brand-500 text-white font-semibold text-lg uppercase">
            ...
            @php
                $menuItems = [
                    ...
                    [
                        ...
                        'path' => route('admin.settings.edit')
                    ],
                ];
            @endphp
