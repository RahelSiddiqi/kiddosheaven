<div class="space-y-12">
    {{-- Page Header --}}
    <div>
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900">About Kiddo's Heaven</h1>
    ...
    <div class="grid lg:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
            ...
            <p class="text-gray-600 leading-relaxed">
                ...
                meet the highest standards of safety, quality, and educational value. From cuddly stuffed animals to innovative
                educational games, every item in our store is carefully selected to delight and develop young minds.
            </p>
            <p class="text-gray-600 leading-relaxed">
                We believe that play is essential for healthy childhood development. That's why we work with renowned brands and
                emerging designers to bring you the best toys from around the world.
            </p>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Free delivery on orders over ৳1,000. Cash on delivery available.</p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
    ...
    {{-- CTA Section --}}
    <section class="bg-gradient-to-r from-primary to-primary-dark rounded-2xl p-8 md:p-12 text-center text-white">
